...
class TodoData extends DataClass implements Insertable<TodoData> {
  ...
  final String title;
  final String status;
  const TodoData({required this.id, required this.title, required this.status});
  @override
  ...
  TodoData copyWith({int? id, String? title, String? status}) => TodoData(
        id: id ?? this.id,
...
abstract class _$Helper extends GeneratedDatabase {
  _$Helper(QueryExecutor e) : super(e);
